...
For `my-consent`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit private personal identifiers or contact details beyond what the consent documents are explicitly meant to disclose.
